import { Link, Form, useParams, useFetcher, type FormProps } from '@remix-run/react'
        ...
        keys.map((type) => {
          ...
          if (resourceResults.nodes[0]?.__typename === 'Product') {
            ...
            return resourceResults.nodes.length ? (
              <SearchResultsProductsGrid key="products" products={productResults} searchTerm={searchTerm} />
            ) : null
          }
...
function pluralToSingularSearchType(
  type: NormalizedPredictiveSearchResults[number]['type'] | Array<NormalizedPredictiveSearchResults[number]['type']>
) {
  const plural = {
    articles: 'ARTICLE',
